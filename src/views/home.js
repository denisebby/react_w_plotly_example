        ...
        <div className="home-header-container1">
          <div className="home-header09">
            <h2 className="home-heading06">
              My name is Denis G. Ebby. I am going to make a website with Teleport.
              Blah Blah Blah. You&apos;re not real.
            </h2>
...
`}
      ...
      <section className="home-faq1">
        <Header></Header>
        <div className="home-container3">
          <span className="home-text77">This is row 1 col 1</span>
          <span className="home-text78">This is row 2 col 1</span>
        </div>
